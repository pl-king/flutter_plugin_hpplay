package com.mxiaotu.flutter_plugin_newhpplay;
...
/**
 * FlutterPluginNewhpplayPlugin
 */
public class FlutterPluginNewhpplayPlugin implements MethodCallHandler {
    ...
    public FlutterPluginNewhpplayPlugin(Registrar registrar) {
        this.mActivity = registrar.activity();
        //初始化事件
//        EventChannel eventChannel = new EventChannel(registrar.messenger(), "flutter_plugin_event_discover_device");
//        eventChannel.setStreamHandler(streamHandler);
//        Log.e(TAG,"EventChannel init");
    ...
    public static void registerWith(Registrar registrar) {
        ...
        channel.setMethodCallHandler(new FlutterPluginNewhpplayPlugin(registrar));
...
//                ToastUtil.show(mActivity, "请先连接设备");
    ...
    private void initDates() {
        mDelayHandler = new UIHandler(mActivity);
        mSDKManager = new SDKManager(mActivity);
        mSDKManager.startMonitor();
        mNetworkReceiver = new NetworkReceiver(mActivity);
